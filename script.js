...
let btn1Suggestion = document.getElementById('btn1Suggestion')
...
btn1Ability.addEventListener('click', function() {
    ...
    btn1Ability.style.backgroundColor = 'chartreuse'
    btn1Ability.style.color = 'black'
    ...
    btn1Suggestion.disabled = true
    btn1Possibility.disabled = true
})

btn1Suggestion.addEventListener('click', function() {
    ...
    btn1Suggestion.style.backgroundColor = 'red'
    btn1Suggestion.style.color = 'yellow'
...
let btn2Suggestion = document.getElementById('btn2Suggestion')
...
btn2Permission.addEventListener('click', function() {
    ...
    btn2Permission.style.backgroundColor = 'chartreuse'
    btn2Permission.style.color = 'black'
...
btn2Ability.addEventListener('click', function() {
    ...
    btn2Ability.style.backgroundColor = 'red'
    btn2Ability.style.color = 'yellow'
...
btn2Suggestion.addEventListener('click', function() {
    let audio = document.getElementById('wrong')
    audio.play()
    let image = document.createElement('img')
    image.setAttribute('src', 'assets/notGood.png')
    ...
    btn2Suggestion.style.backgroundColor = 'red'
    btn2Suggestion.style.color = 'yellow'
    word2.style.color = 'red'
    value--
    document.getElementById('score').innerHTML = value
...
let btn3Suggestion = document.getElementById('btn3Suggestion')
...
btn3Ability.addEventListener('click', function() {
    ...
    btn3Ability.style.backgroundColor = 'chartreuse'
    btn3Ability.style.color = 'black'
    ...
    btn3Ability.disabled = true
    btn3Suggestion.disabled = true
})

btn3Suggestion.addEventListener('click', function() {
    let audio = document.getElementById('wrong')
    audio.play()
    let image = document.createElement('img')
    image.setAttribute('src', 'assets/notGood.png')
    ...
    btn3Suggestion.style.backgroundColor = 'red'
    btn3Suggestion.style.color = 'yellow'
...
btn3Permission.addEventListener('click', function() {
    ...
    btn3Permission.style.backgroundColor = 'red'
    btn3Permission.style.color = 'yellow'
    word3.style.color = 'red'
    value--
    document.getElementById('score').innerHTML = value
...
let btn4Suggestion = document.getElementById('btn4Suggestion')
...
btn4Possibility.addEventListener('click', function() {
    ...
    btn4Suggestion.disabled = true
})

btn4Suggestion.addEventListener('click', function() {
    let audio = document.getElementById('wrong')
    audio.play()
    let image = document.createElement('img')
    image.setAttribute('src', 'assets/notGood.png')
    ...
    btn4Suggestion.style.backgroundColor = 'red'
    btn4Suggestion.style.color = 'yellow'
...
let btn5Suggestion = document.getElementById('btn5Suggestion')
...
btn5Ability.addEventListener('click', function() {
    ...
    btn5Suggestion.disabled = true
    btn5Ability.disabled = true
    btn5Possibility.disabled = true
})

btn5Suggestion.addEventListener('click', function() {
    let audio = document.getElementById('wrong')
    audio.play()
    let image = document.createElement('img')
    image.setAttribute('src', 'assets/notGood.png')
    ...
    btn5Suggestion.style.backgroundColor = 'red'
    btn5Suggestion.style.color = 'yellow'
...
let btn6Suggestion = document.getElementById('btn6Suggestion')
...
btn6Possibility.addEventListener('click', function() {
    ...
    btn6Suggestion.disabled = true
    btn6Possibility.disabled = true
    btn6Ability.disabled = true
})

btn6Suggestion.addEventListener('click', function() {
    let audio = document.getElementById('wrong')
    audio.play()
    let image = document.createElement('img')
    image.setAttribute('src', 'assets/notGood.png')
    ...
    btn6Suggestion.style.backgroundColor = 'red'
    btn6Suggestion.style.color = 'yellow'
...
let btn7Suggestion = document.getElementById('btn7Suggestion')
...
btn7Suggestion.addEventListener('click', function() {
    let audio = document.getElementById('right')
    audio.play()
    let image = document.createElement('img')
    image.setAttribute('src', 'assets/like.png')
    ...
    btn7Suggestion.style.backgroundColor = 'chartreuse'
    btn7Suggestion.style.color = 'black'
...
btn7Permission.addEventListener('click', function() {
    ...
    btn7Permission.style.backgroundColor = 'red'
    btn7Permission.style.color = 'yellow'
